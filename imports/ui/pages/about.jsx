      ...
      <div className="row about">
        <div className="col s12">
          <div className="content-image">
            <img className="left" src="/img/bestsofarFinal2.jpg"/>
          </div>
